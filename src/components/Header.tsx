...
const Header = () => {
  ...
  const navLinkClasses = ({ isActive }: { isActive: boolean }) =>
    cn(
      'text-sm font-medium transition-colors hover:text-doctordicas-blue',
      isActive
        ? 'text-doctordicas-blue'
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <NavLink to="/artigos" className={navLinkClasses}>
              Artigos
            </NavLink>
            <NavLink to="/diagnostico" className={navLinkClasses}>
              Diagnóstico
            </NavLink>
            <NavLink to="/exames" className={navLinkClasses}>
              Interpretar Exames
            </NavLink>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div ref={searchRef} className="relative">
              <button
                ...
                className="p-2 rounded-full text-doctordicas-text-medium hover:bg-gray-100 transition-colors"
                aria-label="Search"
              >
              ...
              {isSearchOpen && (
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg p-2 border">
                  <SearchBar />
                </div>
              )}
            </div>
